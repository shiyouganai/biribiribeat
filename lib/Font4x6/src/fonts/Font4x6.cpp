...
#define CHAR_NUMBER_9 57
  ...
  #define FONT_COLON_INDEX 36
  #define FONT_EXCLAMATION_INDEX 37
  #define FONT_PERIOD_INDEX 38
  #define FONT_UNDERSCORE_INDEX 39
  #define FONT_QUESTION_INDEX 40
#endif
